...
//               <a href="https://samahealth.life/app" target="_blank" rel="noopener noreferrer">
...
const Hero = () => {
  const openApp = (storeType) => {
    ...
    if (isMobile) {
      ...
      window.location.href = "https://samahealth.life/app-deep-link";
      
      setTimeout(() => {
        // If still here after 1 second, redirect to appropriate store
        if (storeType === 'ios') {
      ...
      // Desktop: Go directly to app store
      if (storeType === 'ios') {
        window.open("https://apps.apple.com/ae/app/sama-health/id6447992708", "_blank");
      } else {
        window.open("https://play.google.com/store/apps/details?id=com.sama.health_life", "_blank");
      }
    }
  };
        ...
        <div className="heroLeft">
          ...
          <div className="downloadSection">
            ...
            <div className="storeIcons">
              ...
              <a onClick={() => openApp('ios')} style={{ cursor: 'pointer' }}>
                <img src="/assets/apple.svg" alt="App Store" className="storeBtnImg" />
              </a>
              {/* Updated Android Button */}
              <a onClick={() => openApp('android')} style={{ cursor: 'pointer' }}>
                <img src="/assets/playstore.svg" alt="Google Play" className="storeBtnImg" />
              </a>
            </div>
          </div>
